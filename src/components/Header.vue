...
import { computed } from 'vue';
 ...
 const totalPagar = computed(()=>{
    return props.carrito.reduce((total, iterable)=> total + (iterable.precio * iterable.cantidad), 0)
 })
</script>
                                ...
                                <table class="w-100 table">
                                    ...
                                    <tbody>
                                        <tr v-for="item in carrito">
                                            <td>
                                                <img class="img-fluid" :src="`/img/${item.imagen}.jpg`" :alt="`imagen guitarra ${item.nombre}`">
                                            </td>
                                            <td>SRV</td>
                                            <td class="fw-bold">
                                                    ${{item.precio}}
